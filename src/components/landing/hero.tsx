...
const brandLogos: { id: string; name: string; svg: string }[] = [
  ...
  },
  {
    id: 'spotify',
    name: 'Spotify',
    svg: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'%3E%3Ccircle cx='24' cy='24' r='24' fill='%231DB954'/%3E%3Cpath d='M34.8 33.5c-.4 0-.7-.1-1-.4-5.5-3.3-12.4-4-18.2-2.1-.6.2-1.2.3-1.6.4-.8.2-1.5-.3-1.7-1-.2-.8.3-1.5 1-1.7.5-.1 1.1-.3 1.8-.5 6.6-2.1 14.4-1.2 20.6 2.5.7.4.9 1.3.5 2-.2.5-.8.8-1.4.8zm2-6.2c-.4 0-.8-.1-1.1-.4-6.5-4-15.5-5-22.7-2.7-.6.2-1.3.4-1.7.5-1 .3-2-.3-2.2-1.2-.3-1 .3-2 1.2-2.2.5-.2 1.3-.4 2-.6 8.2-2.6 18.2-1.4 25.6 3.1.8.5 1.1 1.6.6 2.5-.4.6-1 1-1.7 1zm2.3-7.1c-.4 0-.9-.1-1.3-.4-7.5-4.5-19.5-4.9-26.5-2.7-.6.2-1.2.4-1.6.5-1.1.3-2.3-.4-2.6-1.5-.3-1.1.4-2.3 1.5-2.6.5-.2 1.2-.4 1.9-.6 8-2.5 21.3-2 29.9 3.2 1 .6 1.3 1.9.7 2.9-.4.7-1.2 1.2-2 1.2z' fill='%23fff'/%3E%3C/svg%3E"
  },
  {
    id: 'snapchat',
    name: 'Snapchat',
    svg: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23FFFC00'%3E%3Cpath d='M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12 1.033-.301.165-.088.344-.104.464-.104.182 0 .359.029.509.09.45.149.734.479.734.838.015.449-.39.839-1.213 1.168-.089.029-.209.075-.344.119-.45.135-1.139.36-1.333.81-.09.224-.061.524.12.868l.015.015c.06.136 1.526 3.475 4.791 4.014.255.044.435.27.42.509 0 .075-.015.149-.045.225-.24.569-1.273.988-3.146 1.271-.059.091-.12.375-.164.57-.029.179-.074.36-.134.553-.076.271-.27.405-.555.405h-.03c-.135 0-.313-.031-.538-.074-.36-.075-.765-.135-1.273-.135-.3 0-.599.015-.913.074-.6.104-1.123.464-1.723.884-.853.599-1.826 1.288-3.294 1.288-.06 0-.119-.015-.18-.015h-.149c-1.468 0-2.427-.675-3.279-1.288-.599-.42-1.107-.779-1.707-.884-.314-.045-.629-.074-.928-.074-.54 0-.958.089-1.272.149-.211.043-.391.074-.54.074-.374 0-.523-.224-.583-.42-.061-.192-.09-.389-.135-.567-.046-.181-.105-.494-.166-.57-1.918-.222-2.95-.642-3.189-1.226-.031-.063-.052-.15-.055-.225-.015-.243.165-.465.42-.509 3.264-.54 4.73-3.879 4.791-4.02l.016-.029c.18-.345.224-.645.119-.869-.195-.434-.884-.658-1.332-.809-.121-.029-.24-.074-.346-.119-.732-.286-1.228-.675-1.228-1.139-.016-.359.285-.689.735-.853.165-.061.374-.09.555-.09.12 0 .313.031.479.105.39.18.735.288 1.018.3.285.016.45-.061.525-.105l-.033-.511c-.104-1.628-.229-3.654.3-4.848 1.583-3.545 4.94-3.821 5.93-3.821h.416z'/%3E%3C/svg%3E"
  },
  {
    id: 'discord',
    name: 'Discord',
